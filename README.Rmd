...
rCoros provides a tidy interface to the [COROS Training Hub](https://coros.com/traininghub) API. Authenticate once, then pull activities, daily wellness metrics, HRV, workout programmes, and training calendars — all as tibbles ready for dplyr and ggplot2.
