...
|----|----|
| [`coros_login()`](https://mattyoreilly.github.io/rCoros/reference/coros_login.md) | Authenticate; returns a reusable `coros_auth` object |
| [`coros_activities()`](https://mattyoreilly.github.io/rCoros/reference/coros_activities.md) | List activities with auto-pagination |
| [`coros_activity_detail()`](https://mattyoreilly.github.io/rCoros/reference/coros_activity_detail.md) | Lap splits, HR zones, and full summary for one activity |
| [`coros_daily_metrics()`](https://mattyoreilly.github.io/rCoros/reference/coros_daily_metrics.md) | Per-day HRV, RHR, VO2max, training load, stamina |
| [`coros_hrv()`](https://mattyoreilly.github.io/rCoros/reference/coros_hrv.md) | Recent overnight HRV readings (quick dashboard endpoint) |
| [`coros_workouts()`](https://mattyoreilly.github.io/rCoros/reference/coros_workouts.md) | Structured workout library |
| [`coros_schedule()`](https://mattyoreilly.github.io/rCoros/reference/coros_schedule.md) | Planned training calendar |

## API regions

COROS operates separate endpoints for US and EU accounts. If your
account was created in Europe, pass `region = "eu"` to
[`coros_login()`](https://mattyoreilly.github.io/rCoros/reference/coros_login.md).

## Learn more

See
[`vignette("rCoros")`](https://mattyoreilly.github.io/rCoros/articles/rCoros.md)
for a full walkthrough including plots, training-load analysis, and
joining activities to wellness data.
